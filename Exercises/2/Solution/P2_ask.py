...
v0 = float(input("starting velocity of the parachutist: ")) #initial velocity
...
# Exact solution solving a EDO: v(t)=(a/b) + (v0-(a/b))*exp(-b*t))
...
v_exact = (a/b) + (v0-a/b)*np.exp(-b*t_exact) # obtains the exact velocity
